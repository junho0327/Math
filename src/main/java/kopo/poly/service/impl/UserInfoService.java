...
public class UserInfoService implements IUserInfoService {
    ...
    public int insertUserInfo(UserInfoDTO pDTO, String colNm) throws Exception {
        ...
        if (CmmUtil.nvl(rDTO.getExists_yn()).equals("Y")) {
            ...
            if (success > 0) {
                ...
                mDTO.setContents(CmmUtil.nvl(pDTO.getUser_id()) +"님의 회원가입을 진심으로 축하드립니다.");
    ...
    public int getUserLoginCheck(UserInfoDTO pDTO, String colNm) throws Exception {
        ...
        if (CmmUtil.nvl(rDTO.getUser_id()).length()>0) {
            ...
            //메일 내용에 가입자 이름넣어서 내용 발송
            mDTO.setContents(DateUtil.getDateTime("yyyy.MM.dd 24h:mm:ss") +"에 "+ CmmUtil.nvl(rDTO.getUser_id()) +"님이 로그인하였습니다.");
